...
import "./MetaTxHandler.sol";
import "../../wallet/BaseWallet.sol";

/**
 * @title OnlyOwnerModule
 * @dev Module that extends BaseModule and MetaTxHandler for modules where the execute() method
 * must be called with one signature frm the owner.
 */
contract OnlyOwnerModule is BaseModule, MetaTxHandler {
    ...
    */
     ...
     * Unlike its overrided parent, this method can be called via the MetaTxHandler's execute()
