...
describe("Test Approved Transfer", function () {
    ...
    let wallet, guardianHandler, transferModule, priceProvider, kyber, erc20;
    ...
    beforeEach(async () => {
        ...
        await wallet.init(owner.address, [transferModule.contractAddress, guardianHandler.contractAddress]);
    ...
    async function addGuardians(guardians) {
        ...
        for (const address of guardianAddresses) {
            await guardianHandler.from(owner).addGuardian(wallet.contractAddress, address, { gasLimit: 500000 });
        }
    ...
    describe("Transfer approved by EOA guardians", () => {
        it('should transfer ETH with 1 confirmations for 1 guardians', async () => {
            ...
            let count = (await guardianHandler.guardianCount(wallet.contractAddress)).toNumber();
